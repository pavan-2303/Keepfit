...
This folder contains end-user guidance for installing, configuring, and using
Keepfit.
...
- [Health Connect and Assistant](integrations.md)
...
- Core tracking data stays on the device.
