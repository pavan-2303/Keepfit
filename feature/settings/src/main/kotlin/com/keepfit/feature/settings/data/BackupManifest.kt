...
data class BackupSettingsSnapshot(
    ...
    val nutritionTrackingDepth: String = "DETAILED_MACROS",
    ...
    val profileSettings: Map<String, BackupProfileSettingsSnapshot>? = null,
)

data class BackupProfileSettingsSnapshot(
    val weightUnit: String,
    val measurementUnit: String,
    val restTimerSeconds: Int,
    val weeklyReviewPaused: Boolean,
    val nutritionTrackingDepth: String,
    val nutritionTargetRangePercent: Int,
    val workoutReminderEnabled: Boolean,
    val workoutReminderHour: Int,
    val workoutReminderMinute: Int,
    val transformationReminderEnabled: Boolean,
